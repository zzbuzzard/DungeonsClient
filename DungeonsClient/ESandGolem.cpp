...
#else
LootList sandGolemLoot = { itemProb(I_DESERT_RING, 0.005f), itemProb(I_DAMAGER, 0.03f), itemProb(I_SANDSTONE_SWORD, 0.05f), itemProb(I_RUSTY_ARMOUR, 0.2f), itemProb(I_RUSTY_HELMET, 0.3f) };
