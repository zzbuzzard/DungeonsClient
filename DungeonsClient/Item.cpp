...
Item *itemTypes[NUM_ITEMS] = {
	...
	new Item("Cursed elven helmet", ItemRarity::RARE, T_CURSED_ELVEN_HELMET, Equipment::HEAD, Stats(-50, 0, 4, 8, 8, 0, 0, 0)),
	new Item("Vine helmet", ItemRarity::UNCOMMON, T_VINE_HELMET, Equipment::HEAD, Stats(50, 0, 5, 0, 0, 0, 5, 0)),
	...
	new Item("Plant armour", ItemRarity::UNCOMMON, T_PLANT_ARMOUR, Equipment::TORSO, Stats(40, 0, 5, 0, 0, 0, 8, 0)),
	new Item("Sand cape", ItemRarity::COMMON, T_SAND_CAPE, Equipment::TORSO, Stats(0, 0, 3, 5, 0, 0, 0, 0)),
	new Item("Scorpion scale armour", ItemRarity::UNCOMMON, T_SCORPION_SCALE_ARMOUR, Equipment::TORSO, Stats(0, 0, 4, 0, 4, 0, 0, 0)),
	...
	new Item("Beast hide armour", ItemRarity::UNCOMMON, T_BEAST_HIDE_ARMOUR, Equipment::TORSO, Stats(0, 0, 8, 5, 5, 0, 0, 0)),
	...
	new Weapon("Earth staff", ItemRarity::UNCOMMON, T_EARTH_STAFF, Stats(0,0,0,0,0,9,0,0), 60, 8, 0.33f, T_DUST, 2),
	new Weapon("Fire staff", ItemRarity::UNCOMMON, T_FIRE_STAFF, Stats(0,0,0,0,0,8,0,0), 35, 8, 0.25f, T_FIREBALL, 2),
